...
import ru.yandex.practicum.interaction.api.dto.store.SortOrderDto;
...
public class StoreServiceImpl implements StoreService {
    ...
    public ProductPageDto getAllProducts(ProductCategory category, Pageable pageable) {
        ...
        List<SortOrderDto> sortList = pageable.getSort()
                .stream()
                .map(order -> new SortOrderDto(order.getProperty(), order.getDirection().name()))
                .toList();
